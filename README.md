...
La traduction, la gestion complète de l’arborescence, l’historique visible, Quizlet, l’export et la CI sont prévus mais ne sont pas encore livrés. Le fournisseur de traduction sera ajouté derrière `Translator`, avec validation stricte des réponses et gestion des quotas. Le choix documenté pour rester gratuit et ne pas démarrer de serveur est MyMemory ; LibreTranslate reste optionnel et Reverso Context ne sera pas scrapé.
